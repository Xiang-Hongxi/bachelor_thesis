...
plot(TotalPlanningPath(:,1),TotalPlanningPath(:,2),'Color',[1,0.6,0],'LineWidth',2)
...
plot(Stotal,Error,'Color',[1,0.6,0],'LineWidth',2)
...
plot(Stotal,CurvatureOfTotalTentacle,'Color',[1,0.6,0],'LineWidth',2)
...
plot(Stotal,COfTotalTentacle,'Color',[1,0.6,0],'LineWidth',2)
...
%save('Astar_circular_data', 'TotalPlanningPath', 'Stotal', 'Error','CurvatureOfTotalTentacle','COfTotalTentacle')
