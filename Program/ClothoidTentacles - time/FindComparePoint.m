...
% plot(ReferencePath(EndIndexofRP(31),1),ReferencePath(EndIndexofRP(31),2),'x','color',[0,0.45,0.74],'MarkerSize',10,'LineWidth',2)
% hold on
% %绘出ReferencePath上距离Lck的点
% 
% plot(xgnv(EndIndexofTentacle(31),31),ygnv(EndIndexofTentacle(31),31),'x','color',[0,0.45,0.74],'MarkerSize',10,'LineWidth',2)
% %绘出各触须上距离Lck的点
% 
% plot(xgnv(:,31),ygnv(:,31),'color',[0,0.45,0.74])

% plot(ReferencePath(EndIndexofRP(33),1),ReferencePath(EndIndexofRP(33),2),'x','color',[1,0.6,0.78],'MarkerSize',10,'LineWidth',2)
% hold on
% %绘出ReferencePath上距离Lck的点
% 
% plot(xgnv(EndIndexofTentacle(33),33),ygnv(EndIndexofTentacle(33),33),'x','color',[1,0.6,0.78],'MarkerSize',10,'LineWidth',2)
% %绘出各触须上距离Lck的点
% 
% plot(xgnv(:,33),ygnv(:,33),'color',[1,0.6,0.78])
end
